...
if dialogue.OK: #experiment info collected successfully
    ...
    instr4=visual.TextStim(win,text='You will also be asked to keep track of various words.', color=[1,1,1], height=40, wrapWidth=1000)
    space=visual.TextStim(win, text='Press any key to continue', color=[1,1,1], pos=(0, -300))
    instr4.draw()
    space.draw()
    win.flip()
    ...
    instr5=visual.TextStim(win,text='You will respond regarding whether each word matches the word you saw 2 words previously.', color=[1,1,1], height=40, wrapWidth=1000)
    space=visual.TextStim(win, text='Press any key to continue', color=[1,1,1], pos=(0, -300))
    instr5.draw()
    space.draw()
    win.flip()
    ...
    instr6=visual.TextStim(win,text='If a word is the SAME as 2 words ago, press the Space key. If it is NOT THE SAME word as the previous word, do NOT press any keys. For these,  you will NOT receive feedback regarding accuracy.', color=[1,1,1], height=40, wrapWidth=1000)
    space=visual.TextStim(win, text='Press any key to continue', color=[1,1,1], pos=(0, -300))
    instr6.draw()
    space.draw()
    win.flip()
    ...
    instr7=visual.TextStim(win,text='At the beginning of each new Block, you will NOT need to match to the last words from the preceding Block. Therefore, no response is required for the first two words at the beginning of each new Block', color=[1,1,1], height=40, wrapWidth=1000)
    space=visual.TextStim(win, text='Press any key to continue', color=[1,1,1], pos=(0, -300))
    instr7.draw()
    space.draw()
    win.flip()
    ...
    int=[visual.TextStim(win, text='straight', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='curved', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='thick', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='thin', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='solid', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='narrow', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='slim', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='bent', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='wide', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='angled', color=[-1,-1,-1], height=40),
        visual.TextStim(win, text='crooked', color=[-1,-1,-1], height=40)]
    background=visual.Rect(win, width=2000, height=2000, fillColor=[0,0,0])
    
    i=range(len(int))
    interferences = data.TrialHandler(i, 55, method='fullRandom')
    int_order=[]
    ...
    end_text=visual.TextStim(win,text='The experiment has concluded. Please quietly gather your belonging and quietly exit the testing room. If you have any questions, feel free to ask the experimenter. Thank you for your participation!', color=[1,1,1], height=40)
    end_text.draw()
    win.flip()
    core.wait(10)
